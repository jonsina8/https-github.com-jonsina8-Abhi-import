...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002520793005')  # Request channel id (make sure bot is admin)
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+rDsRHXlP_IQ2NGFl')
